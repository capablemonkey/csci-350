(DEFUN ALL-FUNS (LIST)
  (COND
    ((NOT (LISTP LIST)) "ARGUMENT ERROR: EXPECTED A LIST")
    ((ENDP LIST) NIL)
...
(DEFUN COUNTER (TARGET LIST)
  (COND
    ((OR (NOT (LISTP LIST)) (NOT (ATOM TARGET)))
      "ARGUMENT ERROR: EXPECTED AN ATOM AND A LIST")
    ((ENDP LIST) 0)
...
(DEFUN DOT-PRODUCT (A B)
  (IF (OR
    ...
    (RETURN-FROM DOT-PRODUCT "ARGUMENT ERROR: EXPECTED A LIST OF NUMBERS AND A LIST OF NUMBERS"))
...
(DEFUN CARTESIAN-PRODUCT (A B)
  (IF (NOT (AND (LISTP A) (LISTP B)))
    (RETURN-FROM CARTESIAN-PRODUCT "ARGUMENT ERROR: EXPECTED A LIST AND A LIST"))
